  ...
  return (
    <tr>
      ...
      <td className="relative min-w-[100px] md:min-w-[150px]">
        <svg xmlns="http://www.w3.org/2000/svg" className="absolute left-2 top-1/2 h-6 w-6 -translate-y-1/2 text-gray-400 sm:left-4" fill="currentColor" viewBox="0 0 24 24">
  <text x="50%" y="50%" text-anchor="middle" dominant-baseline="middle" font-size="18">&#x20B9;</text>
</svg>
        <InvoiceField
          onEditItem={(event) => onEdtiItem(event)}
          cellData={{
